...
<node CREATED="1607895274741" ID="ID_289602725" MODIFIED="1607908269095" TEXT="1.4 Selected MP Interface">
...
<node CREATED="1607895582437" ID="ID_712218429" MODIFIED="1607908271100" TEXT="1.5 Preferences Page">
...
<node CREATED="1607896491272" ID="ID_104417048" MODIFIED="1607908275849" TEXT="1.6 Accounts Interface">
...
<node CREATED="1607897020682" ID="ID_170183427" MODIFIED="1607908218476" TEXT="1.6.2.1 User Email Page">
...
<node CREATED="1607897038618" ID="ID_1729709490" MODIFIED="1607908219740" TEXT="1.6.2.2 User Username Page">
...
<node CREATED="1607897038618" ID="ID_118908833" MODIFIED="1607908220621" TEXT="1.6.2.3 User Constituency Page">
...
<node CREATED="1607897048458" ID="ID_262816662" MODIFIED="1607908221420" TEXT="1.6.2.3 User Password Page">
...
<node CREATED="1607906861320" ID="ID_67788218" MODIFIED="1607906883188" TEXT="2.2.1.1 Sign Up data">
<node CREATED="1607904001985" ID="ID_515822062" MODIFIED="1607906902436" TEXT="2.2.1.1.1 Respond to email sent by client">
<node CREATED="1607904319648" ID="ID_201437415" MODIFIED="1607906915172" TEXT="2.2.1.1.1.1 search database for email"/>
<node CREATED="1607904346338" ID="ID_69679640" MODIFIED="1607906924900" TEXT="2.2.1.1.1.2 if email not found respond SUCCESS else respond EMAILTAKEN and listen again"/>
<node CREATED="1607906225397" ID="ID_571059921" MODIFIED="1607906943524" TEXT="2.2.1.1.1.3 store email in database"/>
</node>
<node CREATED="1607906019285" ID="ID_550084342" MODIFIED="1607906896292" TEXT="2.2.1.1.2 respond to username sent by client">
<node CREATED="1607906032133" ID="ID_50405132" MODIFIED="1607906952453" TEXT="2.2.1.1.2.1 search databse for username"/>
<node CREATED="1607906045846" ID="ID_416936223" MODIFIED="1607906964019" TEXT="2.2.1.1.2.2 if username not found respond SUCCESS else respond USERNAMETAKEN and listen again"/>
<node CREATED="1607906184533" ID="ID_922577251" MODIFIED="1607907816136" TEXT="2.2.1.1.2.3 store username associated with email in database"/>
</node>
<node CREATED="1607906119365" ID="ID_1387242062" MODIFIED="1607906892036" TEXT="2.2.1.1.3 respond to password sent by client">
<node CREATED="1607906132453" ID="ID_1486030079" MODIFIED="1607907819416" TEXT="2.2.1.1.3.1 store password and respond SUCCESS"/>
</node>
</node>
<node CREATED="1607907846413" ID="ID_1629426552" MODIFIED="1607908484986" TEXT="2.2.1.2 User Associated data">
<node CREATED="1607907890188" ID="ID_1579633843" MODIFIED="1607907927416" TEXT="2.2.1.2.1 respond to favourite list request by client">
<node CREATED="1607908301901" ID="ID_439886653" MODIFIED="1607908433769" TEXT="2.2.1.2.1.1 if request for users favourite list is valid, return favourite data, else return error"/>
</node>
<node CREATED="1607907940604" ID="ID_210069165" MODIFIED="1607907971353" TEXT="2.2.1.2.2 respond to constituency request sent by client">
<node CREATED="1607908376303" ID="ID_1637102085" MODIFIED="1607908425146" TEXT="2.2.1.2.2.1 if request for users constituency is valid, return constituency as string, else return error"/>
</node>
<node CREATED="1607908496655" ID="ID_1802316478" MODIFIED="1607908510698" TEXT="2.2.1.2.3 respond to add favourite request by client"/>
</node>
</node>
</node>
</node>
